...
export default function SearchFriendAllEventScreen() {
  ...
  const fetchData = async () => {
    try {
      ...
      const response = await API.get(`/event/acquaintance/nickname?name=${name}`, {
        headers: {
          Authorization: token,
      ...
      console.log("total", newData.allAcEvents);
