...
const ComponentBasedOnCount = ({ countUp, handleButtonClick, postData, modalOpenClick, handleAddData, modalVisible, handelCountUp }) => {
  switch (countUp) {
    case 1:
    ...
    case 6:
      return <MoneyInputComponent handleButtonClick={handleButtonClick} handleAddData={handleAddData} modalOpenClick={modalOpenClick} />;
    default:
