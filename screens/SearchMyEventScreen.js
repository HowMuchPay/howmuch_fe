...
const SearchMyEventScreen = () => {
  ...
  const renderAutocompleteItem = ({ item }) => {
    ...
    return (
      <>
        <Pressable onPress={() => handleAutocompleteSelection(item)} style={styles.nameBox}>
          <WithLocalSvg width={24} height={24} asset={searchIcon} style={{}} />
    ...
    <View style={styles.container}>
      <View style={styles.inner}>
        <View style={styles.nameInputBox}>
          ...
          <FlatList data={filteredData} renderItem={renderAutocompleteItem} keyExtractor={(item) => item.toString()} style={styles.nameList} />
        </View>
      </View>
    </View>
  );
