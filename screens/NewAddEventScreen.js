    ...
    <View style={styles.container}>
        <View style={styles.inner}>
            ...
            <View style={styles.addBtnBox}>
                <TouchableOpacity style={[styles.addBtn,{backgroundColor:"#F3F3FF"}]}>
                ...
                >
                    <View style={styles.modalBox}>
                        ...
                        <View style={styles.modalBtnBox}>
                            <TouchableOpacity style={[styles.modalBtn, {backgroundColor: "#f3f3ff"}]}><Text style={styles.modalBtnText}>아니요</Text></TouchableOpacity>
                            <TouchableOpacity style={[styles.modalBtn, {backgroundColor: "#6D61FF"}]}><Text style={[styles.modalBtnText, {color: "#fff"}]}>네</Text></TouchableOpacity>
                        </View>
                    </View>
                </Modal>
