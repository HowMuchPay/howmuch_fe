...
import UpdateMoneyInputComponent from "../components/UpdateMoneyInputComponent";
...
const ComponentBasedOnCount = ({ countUp, handleButtonClick, postData, modalOpenClick, handleAddData, modalVisible, handleCountUp, eventData }) => {
  switch (countUp) {
    ...
    case 4:
      return (
        <NameInputComponent
          ...
          myType={postData[2]}
          eventType={postData[3]}
          modalOpenClick={modalOpenClick}
          type={"friend"}
          placeholder={eventData.nickname}
        />
      );
    case 5:
      if (postData[3] === 4) {
    ...
    case 6:
      return <UpdateMoneyInputComponent handleButtonClick={handleButtonClick} handleAddData={handleAddData} modalOpenClick={modalOpenClick} placeholder={eventData.payAmount} />;
    default:
      return <CalendarSelectComponent handleButtonClick={handleButtonClick} placeholder={eventData.eventAt} />;
  }
};
